...
# in below example, attempts remaining only shown when an initial wrong pin has been typed
...
while supplied_pin != correct_pin:
        while attempts < attempts_allowed:
                ...
                # getpass method & module should mean the password typed in the terminal is not shown
